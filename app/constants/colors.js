...
export const themes = {
	...
	red: {
		backgroundColor: '#e2594c',
		focusedBackground: '#e2594c',
		chatComponentBackground: '#f6cfcc',
		auxiliaryBackground: '#eea099',
		bannerBackground: '#f1f2f4',
		titleText: '#ffffff',
		bodyText: '#ffffff',
		...
		tintColor: '#D61200',
		auxiliaryTintColor: '#caced1',
		actionTintColor: '#D61200',
		separatorColor: '#ffffff',
		navbarBackground: '#e2594c',
		headerBorder: '#e67066',
		headerBackground: isIOS ? '#ffd9d6' : '#ffffff',
		headerSecondaryBackground: '#e2594c',
		headerTintColor: isAndroid ? '#e2594c' : '#D61200',
		headerTitleColor: isAndroid ? '#e2594c' : '#700900',
		headerSecondaryText: isAndroid ? '#ffffff' : '#D61200',
		toastBackground: '#0C0D0F',
		videoBackground: '#1f2329',
		favoriteBackground: '#ffbb00',
		hideBackground: '#54585e',
		messageboxBackground: '#e2594c',
		searchboxBackground: '#eea099',
		buttonBackground: '#414852',
		buttonText: '#ffffff',
		passcodeBackground: '#EEEFF1',
		passcodeButtonActive: '#E4E7EA',
